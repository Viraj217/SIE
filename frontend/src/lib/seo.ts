export const SITE_URL = "https://shahindustrial.com";
...
export const businessInfo = {
  ...
  founded: "1989",
  description:
    "Steel and iron merchants in Darukhana, Mazgaon, Mumbai supplying custom-cut shafts, rods, alloy bars, and industrial raw materials.",
  address: {
    street: "Darukhana, Mazgaon",
    locality: "Mumbai",
    region: "Maharashtra",
    postalCode: "400010",
    country: "IN",
  },
  phones: ["+919324797660", "+919820023666"],
  contacts: [
...
export const seoFaqs = [
  ...
  },
  {
    ...
    answer:
      "The business supplies mild steel shafts, carbon steel rods, alloy grades including EN8, EN9, EN19 and EN24, and custom-cut industrial raw material.",
  },
  {
